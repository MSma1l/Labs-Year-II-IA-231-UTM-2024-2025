  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
      ...
      <form onSubmit={handleSubmit} className="mb-8">
        <div className="mb-4">
          <label htmlFor="name" className="block text-sm font-medium text-gray-700">Nume Activitate</label>
          <input
            type="text"
            id="name"
            name="name"
      ...
      <div>
        <h3 className="text-2xl font-semibold mb-4">Activitați Curente</h3>
        {projects.length === 0 ? (
          <p>Nu există Activități momentan.</p>
        ) : (
